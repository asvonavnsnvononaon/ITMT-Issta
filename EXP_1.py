...
if __name__ == "__main__":
    ...
    EXP = [
        "A Flashing Red Light Stop completely before entering the crosswalk or intersection, then proceed when you can do so safely.",
        "You must yield the right-of-way to police cars.",
        ...
        "When entering or crossing a road, street, or highway from a private road, alley, building, or driveway, you must stop prior to the sidewalk and yield the right-of-way to all approaching vehicles and pedestrians.",
        "You are near a school. Slow down, watch for children, and prepare to stop suddenly if necessary.",
        "When you are in a construction and maintenance work area, be prepared to slow down or stop as you approach workers and equipment",
        "Be on the lookout for cyclists on the road, especially at intersections.",
        "When you are in a construction and maintenance work area, be prepared: 1. To slow down or stop as you approach workers and equipment.",
        "RIGHT LANE MUST TURN RIGHT sign: Vehicles driving in the right lane must turn right at the next intersection unless the sign indicates a different turning point.",
        "The sign means traffic in the left lane must turn left",
        "Many rear-end collisions occur on icy streets because drivers don’t leave space to stop.  To keep safe, you must keep your distance.",
        "Slow down and increase the following distance when the road is wet.",
        "Slow down and prepare to stop when visibility is poor, for example, in fog.",
        'Slow down when driving at night and be sure you can stop within the distance lit by your headlights.',
        "More than half of all pedestrian fatalities occur in darkness or at dusk. Slow down and prepare to stop when visibility is poor."]
